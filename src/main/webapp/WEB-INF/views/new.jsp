...
<body>
	<div class="container">
		...
		<form action="/olakoa/home/drinks/create" method="POST">
			...
			<div class="form-group">
				...
				<input type="url" class="form-control" id="thumb" placeholder="Thumbnail URL" name="thumb" required>
			</div>
			<div class="form-group">
				<label for="cost">Unit Price</label>
				<input type="number" class="form-control" id="cost" placeholder="Unit price (cents)" name="cost" required>
			</div>
			<div class="checkbox">
				<label> <input type="checkbox" id="posted" name="posted"> Posted </label>
			</div>
